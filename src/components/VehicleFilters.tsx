...
export function VehicleFilters() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block rounded-lg border bg-card p-4">
        <h2 className="text-sm font-medium text-muted-foreground mb-3">Filtros</h2>
        {filterContent}
      </div>

      {/* Mobile: filtros colapsables */}
      <div className="lg:hidden">
        <Accordion type="single" collapsible value={open ? 'filters' : ''} onValueChange={(v) => setOpen(v === 'filters')}>
