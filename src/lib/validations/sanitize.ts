 ...
 * Usar en backend y, si aplica, en frontend antes de enviar.
 */
...
/**
 * Elimina o escapa HTML/scripts de un string.
 */
...
/**
 * Sanitiza un objeto aplicando sanitizeString a valores string.
 */
